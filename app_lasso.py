...
st.markdown("""
            <div class = "card">
            <h1>Lasso Regression App</h1>
            <p> Predict<b> Tip Amount </b> from <b> Total Bill </b> using Lasso Regression</p>
            </div>
...
st.markdown('<div class = "card"><h2>Lasso Regularization Parameter</h2></div>', unsafe_allow_html = True)
